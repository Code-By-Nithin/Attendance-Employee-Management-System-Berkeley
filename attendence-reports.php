                                    ...
                                    <div class="row">
                                        <?php foreach ($sections as $section): ?>
                                            <?php foreach (['Day', 'Night'] as $shift): ?>
                                                <?php
                                                // First check if there are any employees in this section and shift
                                                $checkQuery = "SELECT COUNT(*) as count FROM employees e
                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table table-bordered">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    $query = "SELECT DISTINCT e.id, e.name, e.bid, e.cwkid 
                                                                              FROM employees e
                                                                              JOIN attendance a ON e.id = a.employee_id
                                                                              WHERE a.section = '$section' AND a.shift = '$shift'
                                                                              AND (e.name LIKE '%$searchQuery%' OR e.bid LIKE '%$searchQuery%' OR e.cwkid LIKE '%$searchQuery%')
                                                                    ...
                                                                    // Initialize array to store present counts for each date
                                                                    $presentCounts = array_fill_keys($filteredDates, 0);
                                                                    ...
                                                                    // Add total present count row
                                                                    echo "<tr class='total-count'>";
                                                                    echo "<td colspan='3'>Total Present</td>";
                                                                    foreach ($filteredDates as $date) {
                                                                        echo "<td>" . $presentCounts[$date] . "</td>";
                                                                    }
                                                                    echo "</tr>";
                                                                    ?>
                                                                </tbody>
