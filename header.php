                  ...
                  <div class="col-8">
                    <div class="p-4 pb-3">
                      ...
                      <div class="row">
                        <div class="col-6">
                          <div class="position-relative">
                            <a href="users.php" class="d-flex align-items-center pb-9 position-relative">
                              <div
                                class="bg-primary-subtle rounded round-48 me-3 d-flex align-items-center justify-content-center">
                                <iconify-icon icon="solar:user-outline" class="fs-7 text-primary"></iconify-icon>
                              </div>
                              <div class="d-inline-block">
                                <h6 class="mb-0">Employees</h6>
                                <span class="fs-11 d-block text-body-color">View All Staffs</span>
                              </div>
                            </a>
                            <a href="attendance.php" class="d-flex align-items-center pb-9 position-relative">
                              <div
                              ...
                              <div class="d-inline-block">
                                ...
                                <span class="fs-11 d-block text-body-color">Mark All Attendence</span>
                              </div>
                            </a>
                            <a href="ppe-sheet-form.php" class="d-flex align-items-center pb-9 position-relative">
                              <div
                                class="bg-warning-subtle rounded round-48 me-3 d-flex align-items-center justify-content-center">
                                <iconify-icon icon="solar:bill-list-broken" class="fs-7 text-warning"></iconify-icon>
                              </div>
                              <div class="d-inline-block">
                                <h6 class="mb-0">PPE Sheet</h6>
                                <span class="fs-11 d-block text-body-color">PPE Sheet Record</span>
                              </div>
                            </a>
                          </div>
                        </div>
                        <div class="col-6">
                          <div class="position-relative">
                            <a href="duty-roster.php" class="d-flex align-items-center pb-9 position-relative">
                              <div
                              ...
                              <div class="d-inline-block">
                                <h6 class="mb-0">Duty Roster</h6>
                                <span class="fs-11 d-block text-body-color">Find the Off Days</span>
                              </div>
                            </a>
                            <a href="ppe-report.php" class="d-flex align-items-center pb-9 position-relative">
                              <div
                                class="bg-primary-subtle rounded round-48 me-3 d-flex align-items-center justify-content-center">
                                <iconify-icon icon="solar:calendar-minimalistic-bold-duotone"
                              ...
                              <div class="d-inline-block">
                                <h6 class="mb-0">PPE Record</h6>
                                <span class="fs-11 d-block text-body-color">Download Sheet</span>
                              </div>
                            </a>
                            <a href="attendence-reports.php" class="d-flex align-items-center pb-9 position-relative">
                              <div
                                class="bg-secondary-subtle rounded round-48 me-3 d-flex align-items-center justify-content-center">
                                <iconify-icon icon="solar:bill-list-bold-duotone"
                                  class="fs-7 text-secondary"></iconify-icon>
                              ...
                              <div class="d-inline-block">
                                <h6 class="mb-0">Attendence Report</h6>
                                <span class="fs-11 d-block text-body-color">Collect The Attendence</span>
                              </div>
                            </a>
                          </div>
                        </div>
              ...
              <div class="dropdown-menu profile-dropdown dropdown-menu-end dropdown-menu-animate-up"
                ...
                <div class="position-relative px-4 pt-3 pb-2">
                  <div class="d-flex align-items-center mb-3 pb-3 border-bottom gap-6">
                    ...
                    <!-- User Info Display (CSS remains untouched) -->
                    <div>
                      <h5 class="mb-0 fs-12"><?php echo htmlspecialchars($email); ?> <span
                          class="text-success fs-11">Active</span></h5>
                      <p class="mb-0 text-dark"><?php echo ucfirst($role); ?></p>
                    </div>
    ...
    <nav class="navbar navbar-expand-xl container-fluid p-0">
      <ul class="navbar-nav align-items-center">
        ...
        <li class="nav-item d-none d-xl-flex align-items-center">
          <a href="dashboard.php" class="text-nowrap nav-link">
            <img src="assets/images/logos/logo.svg" alt="matdash-img">
          </a>
        </li>
        ...
        <div class="d-flex align-items-center justify-content-between px-0 px-xl-8">
          <ul class="navbar-nav flex-row mx-auto ms-lg-auto align-items-center justify-content-center">
            ...
            <li class="nav-item d-block d-xl-none">
              <a class="nav-link nav-icon-hover-bg rounded-circle" href="javascript:void(0)" data-bs-toggle="modal"
